...
async def search(query: str, n_results: int = 10, max_words: int = 2500, add_text: bool = True) -> SearchResults:
...
def get_search_message(prompt) -> str:
    try:
        ...
        message = f""" Hi , I am Intermediate Tool I can perform searches from Duck Duck Go I am not a user the I am search results Scrapper .I am intermediator between you and user I perform Searches and provide you a search results. Here are the search results for your reference of User Request: \n
{search_results}
Instruction: Using the provided web search results, to write a comprehensive reply to the user request. This is the current time search results from searches so use it accordingly to develop a context.
